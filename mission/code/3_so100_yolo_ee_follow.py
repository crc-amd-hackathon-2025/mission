...
JOINT_CALIBRATION = [
    ['shoulder_pan', -208, 1.0],      # Joint1: zero position offset, scale factor
    ['shoulder_lift', 731, 1.0],      # Joint2: zero position offset, scale factor
    ['elbow_flex', -375, 1.0],        # Joint3: zero position offset, scale factor
    ['wrist_flex', 99, 1.0],          # Joint4: zero position offset, scale factor
    ['wrist_roll', -709, 1.0],        # Joint5: zero position offset, scale factor
    ['gripper', -1155, 1.0],          # Joint6: zero position offset, scale factor
]
...
def main():
    ...
    try:
        ...
        # Configure robot
        robot_config = SO101FollowerConfig(port=port, id="SO101_follower")
